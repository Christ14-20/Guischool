...
export async function getStudentPayments(
  ...
  const data = await request<Record<string, unknown>>("/finance/payments/", {
    token,
...
export async function createPayment(
  ...
  return request<PaymentItem>("/finance/payments/", {
    token,
    method: "POST",
    body,
  });
...
export async function getStudentFinancialSummary(
  ...
  try {
    ...
    const response = await request<PaginatedResult<InvoiceItem>>(
      "/finance/invoices/",
      {
        token,
...
export async function getInvoices(
  ...
  const data = await request<Record<string, unknown>>("/finance/invoices/", {
    token,
    query,
  });
  return {
...
export async function createFeeCategory(
  ...
  return request<FeeCategoryItem>("/finance/feecategories/", {
    token,
    method: "POST",
    body,
  });
...
export async function updateFeeCategory(
  ...
  return request<FeeCategoryItem>(`/finance/feecategories/${id}/`, {
    token,
    method: "PATCH",
    body,
  });
