    ...
    <Page size="A5" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.receiptNumber}>
          N° {payment.receipt_number || payment.id.substring(0, 8)}
        </Text>
      </View>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>
              {payment.student_name || "Élève inconnu"}
            </Text>
          </View>
      ...
      <Text style={styles.footer}>
        Document généré le {new Date().toLocaleString("fr-FR")} • Ce reçu est
        une preuve de paiement valide.
      </Text>
    </Page>
  </Document>
);
