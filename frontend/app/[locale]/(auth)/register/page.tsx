      ...
      <Card className="w-full max-w-xl shadow-lg border-primary/20 relative">
        <CardHeader>
          ...
          <div className="mt-4 flex text-sm font-medium">
            {steps.map((step, idx) => (
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center border-2 mb-2 z-10 bg-background ${idx <= currentStep ? "border-primary text-primary" : "border-muted-foreground/30 text-muted-foreground"}`}
                >
                  {idx + 1}
                </div>
                ...
                {idx !== steps.length - 1 && (
                  <div
                    className={`absolute top-4 left-[50%] h-[2px] w-full ${idx < currentStep ? "bg-primary" : "bg-muted-foreground/20"}`}
                  />
                )}
              </div>
            ))}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="admin@ecole.com" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="AG-XYZ-2024" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Conakry, Kaloum" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
        ...
        <CardFooter className="flex justify-between items-center w-full">
          ...
          <div className="flex gap-2">
            <Link href={`/${locale}/login`}>
              <Button type="button" variant="ghost" disabled={isSubmitLoading}>
                {t("back")}
              </Button>
            </Link>
