...
import { Filter, RefreshCw, Ticket, ChevronRight } from "lucide-react";
...
export default function TicketsPage() {
  ...
  const resolvedCount = tickets.filter(
    (t) => t.status === "RESOLU" || t.status === "FERME",
  ).length;
        ...
        >
          ...
          <SelectContent>
            {STATUS_OPTIONS.map((o) => (
              <SelectItem key={o.value || "__all_status"} value={o.value}>
                {o.label}
              </SelectItem>
            ))}
          </SelectContent>
        ...
        >
          ...
          <SelectContent>
            {CATEGORY_OPTIONS.map((o) => (
              <SelectItem key={o.value || "__all_cat"} value={o.value}>
                {o.label}
              </SelectItem>
            ))}
          </SelectContent>
        ...
        >
          ...
          <SelectContent>
            {PRIORITY_OPTIONS.map((o) => (
              <SelectItem key={o.value || "__all_prio"} value={o.value}>
                {o.label}
              </SelectItem>
            ))}
          </SelectContent>
              ...
              <TableRow>
                <TableCell colSpan={8} className="h-32 text-center">
                  <div className="flex flex-col items-center gap-2 text-muted-foreground">
                    ...
                    <p className="text-xs">
                      Créez votre premier ticket en cliquant sur « Nouveau
                      ticket ».
                    </p>
                  </div>
                </TableCell>
