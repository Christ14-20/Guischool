    ...
    <section className="space-y-5">
        ...
        actions={
          <>
            <Button
              variant="outline"
              nativeButton={false}
              render={<Link href={`/${locale}/app/pedagogie`} />}
            >
            ...
            <Button
              nativeButton={false}
              render={<Link href={`/${locale}/app/finance`} />}
            >
      ...
      <div className="grid gap-4 xl:grid-cols-[1.35fr_0.65fr]">
        <Card className="border-border/70 bg-card/90">
          <CardHeader>
            ...
            <CardDescription>
              Progression des operations critiques
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-border/70 bg-card/90">
          <CardHeader>
            ...
            <CardDescription>
              Raccourcis utiles pour l administration
            </CardDescription>
          </CardHeader>
      ...
      <Card className="border-border/70 bg-card/90">
        <CardHeader>
          ...
          <CardDescription>
            Dernieres operations enregistrees dans la plateforme
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
              ...
              {RECENT_ACTIVITY.map((item) => (
                <TableRow key={`${item.actor}-${item.action}`}>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        item.status === "Termine" ? "default" : "secondary"
                      }
                    >
                      {item.status}
                    </Badge>
