...
import { getInvoiceDetails, getPayments, generateInvoicePdf, type InvoiceItem, type PaymentItem } from '@/lib/api/finance';
...
export default function InvoiceDetailsPage() {
  ...
  if (!invoice) {
    return <div className="p-8 text-center text-red-500">Facture introuvable.</div>;
  }
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-card border rounded-md p-5 shadow-sm space-y-4">
            <div className="flex justify-between items-center border-b pb-3">
              <h3 className="font-semibold text-lg text-card-foreground">Résumé</h3>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{invoice.student_name || invoice.student}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between pt-3 border-t">
                ...
                <span className="font-medium">{formatCurrency(invoice.total_due)}</span>
              </div>
              <div className="flex justify-between">
        ...
        <div className="md:col-span-2">
          <div className="bg-card border rounded-md shadow-sm overflow-hidden">
            <div className="p-4 border-b bg-muted/30">
              <h3 className="font-semibold text-card-foreground">Historique des Paiements (Élève)</h3>
            </div>
            <Table>
              <TableHeader>
                <TableRow>
                ...
                {payments.length === 0 ? (
                  ...
                  payments.map((p) => (
                    <TableRow key={p.id}>
                      ...
                      <TableCell className="font-mono text-xs">{p.receipt_number || p.id.substring(0,8)}</TableCell>
