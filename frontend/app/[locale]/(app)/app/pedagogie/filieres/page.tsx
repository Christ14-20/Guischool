...
export default function FilieresPage() {
  ...
  useEffect(() => {
    ...
    getFilieres(token)
      .then((res) => {
        if (mounted) setFilieres(res.results);
      })
      .catch((e) =>
  ...
  const filieresByCycle = filieres.reduce<Record<string, FiliereItem[]>>(
    (acc, f) => {
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  setDialogMode({ type: "edit", filiere: f })
                                }
                              >
                                Modifier
                              </Button>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Codes des matières séparés par des virgules (ex: FR, MATH,
                    PC, SVT, ANG)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
