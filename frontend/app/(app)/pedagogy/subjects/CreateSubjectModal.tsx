          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-card border border-line rounded-2xl shadow-[var(--shadow)] w-full max-w-md mx-4 p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-serif text-lg font-medium text-text">Nouvelle matière</h2>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <input type="hidden" name="is_official" value="true" />
                  <input
                    type="checkbox"
                    name="is_official"
                    id="is_official"
                  ...
                  />
                  <label htmlFor="is_official" className="text-sm text-text-soft">
